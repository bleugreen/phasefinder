...
def calculate_transition_probs(
    ...
    transition_probs = torch.where(
        expected_phase_diff <= distance_threshold,
        1.0 - (expected_phase_diff / distance_threshold),
...
def backtrack(backpointers: torch.Tensor) -> list[int]:
